...
import com.liutf.mvc.entity.WeChat;
import com.liutf.mvc.service.CoreService;
import com.liutf.mvc.utils.SignUtil;
...
public class XxtController {
	...
	public String getWeiXinMessage(HttpServletRequest request,
		...
		System.out.println("--------------------进入post方法进行验证!--------------------");
